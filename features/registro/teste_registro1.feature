...
Funcionalidade: Testar o processo de registro
  ...
  Cenário: Registro com sucesso
    ...
    Quando eu preencho os campos obrigatórios com nome "Leo", e-mail "leonardo.watanabe@usp.br", senha "moraya", nome de usuário "leo2217" e marco as caixas de seleção
